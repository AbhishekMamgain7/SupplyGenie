        ...
        <>
            {!chatOpen && (
                <div className="chatbot-tooltip">
                    ...
                    <p className="chatbot-tooltip-subtitle">SupplyGenie</p>
                </div>
            )}
            <button onClick={toggleChatbot} className="chatbot-toggle-button">
                <img src={chatIcon} alt="Open Chatbot" />
            </button>

            {chatOpen && (
                <div className="chatbot-wrapper">
                    <div className="chatbot-header">
                        <span>SupplyGenie</span>
                        <button onClick={toggleChatbot} className="chatbot-close">close</button>
                    </div>
